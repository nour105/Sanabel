    ...
    <section className="container mx-auto py-16 px-4 md:px-0">
      ...
      <div className="flex flex-col md:flex-row items-center gap-12 mb-16">
        <div className="md:w-1/2">
          <img
            src="https://sanabelauto.com/storage/about-us.jpg"
            alt="About Sanabel Auto"
        ...
        <div className="md:w-1/2 space-y-4">
          ...
          <p className="text-gray-600">
            Sanabel Auto is committed to providing the best car buying experience in Saudi Arabia. 
            We offer a wide range of vehicles, exceptional service, and a customer-first approach.
          </p>
          <p className="text-gray-600">
            With years of experience in the automotive industry, we understand your needs and strive to provide 
      ...
      <div className="grid md:grid-cols-2 gap-12 mb-16 text-center">
        ...
        <div className="bg-white rounded-3xl shadow-lg p-8">
          <h3 className="text-xl font-bold text-indigo-600 mb-4">Our Vision</h3>
          <p className="text-gray-600">

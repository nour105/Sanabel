  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="px-4 py-2 rounded-full border border-gray-300 text-sm font-semibold bg-white hover:bg-gray-100 transition flex items-center gap-2"
      >
        ...
        >
          <button
            ...
            className={`w-full px-4 py-2 text-sm hover:bg-gray-100 transition
              ${lang === 'en' ? 'font-semibold text-indigo-600' : ''}`}
          >
            English
          </button>
          ...
          <button
            ...
            className={`w-full px-4 py-2 text-sm hover:bg-gray-100 transition
              ${lang === 'ar' ? 'font-semibold text-indigo-600' : ''}`}
          >
            العربية
          </button>
        </div>
